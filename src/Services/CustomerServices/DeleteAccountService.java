 ...
 ********************************************************************************************************
*/
public class DeleteAccountService extends App  {
    ...
    */
    public static  boolean deleteAccount() throws CustomException{
        ...
        fl = ManagerService.removeAccount(currentCustomer.accounts.get(key-1));
        if(fl){
            currentCustomer.accounts = AccountRepo.findAccounts(currentCustomer);
            throw new CustomException("Account Deleted :)");
        }
        return fl;
    }
